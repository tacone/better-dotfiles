      ...
      Item {
        ...
        Keys.onPressed: function(event) {
          ...
          if (event.key === Qt.Key_Delete) {
            ...
            // LOCAL PATCH: upstream omarchy.menu's input mode has no paste path,
            // so Ctrl+V / Shift+Insert are dropped. Append the system clipboard.
            // Bitmask checks tolerate extra modifier bits (CapsLock/NumLock).
